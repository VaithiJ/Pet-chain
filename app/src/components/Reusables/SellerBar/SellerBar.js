    ...
    <nav class="navbar">
      ...
      <div className={`menu-items-nvmenu ${isMenuOpen ? "show" : ""}`}>
        <div class="menu-nvmenu menu-left-nvmenu">
          <a className="likn"  href="/seller">Home</a>
          <a className="likn" href="/sellitem">Sell</a>
          {/* <a className="likn" href="/order" target="_blank">
            Orders
          </a> */}
          {/* <a href="/marketplace">Contact</a> */}
        </div>
      </div>
